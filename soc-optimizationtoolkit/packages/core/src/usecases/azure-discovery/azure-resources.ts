// VERBATIM PORT (compatibility exception, porting-plan Unit 2): copied from
// legacy Cribl-Microsoft_IntegrationSolution/src/renderer/hooks/azure-resources.ts
// with its tests as characterization fixtures. Only this provenance header was
// added; the code below is unchanged. It is the RG-list-denied fallback: when
// the dedicated resource-group list call is denied, the resource-group choices
// are derived from workspace metadata instead (see listResourceGroupChoices).
//
