// CHARACTERIZATION FIXTURES (porting-plan Unit 2): ported verbatim from legacy
// Cribl-Microsoft_IntegrationSolution/src/renderer/hooks/azure-resources.test.ts.
// Only the import path changed. These pin the verbatim compatibility port of
// deriveResourceGroupsFromWorkspaces - do not "improve" the expectations.
