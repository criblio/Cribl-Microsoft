...
/**
 * The serialized-byte budget for one stored tagged sample. 512 KiB sits well
 * under a typical 1 MB leader body limit while leaving headroom for the JSON
 * envelope. The cloud/local adapters apply this before writing.
 */
export const TAGGED_SAMPLE_MAX_BYTES = 512 * 1024;
