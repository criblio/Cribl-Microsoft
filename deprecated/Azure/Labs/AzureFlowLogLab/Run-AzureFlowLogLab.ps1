...
function Test-AzureParametersConfiguration {
 ...
 Write-Host "`n Invalid vnetAddressPrefix: Must be in CIDR notation (e.g., 10.0.0.0/24)" -ForegroundColor Yellow
 return $false
 }
...
function Execute-Mode {
 ...
 Write-Host "`n⏱ Estimated time: 30-45 minutes (VPN Gateway deployment)" -ForegroundColor Yellow
 ...
 Write-Host " • Virtual Network: $vnetName ($($azParams.vnetAddressPrefix))" -ForegroundColor White
 Write-Host " • Gateway Subnet: $($azParams.subnets.gateway.addressPrefix)" -ForegroundColor White
 Write-Host "`n⏱ Estimated time: 1-2 minutes" -ForegroundColor Yellow
 ...
 Write-Host "`n This requires an existing vNet with GatewaySubnet" -ForegroundColor Yellow
 ...
 Write-Host " • VPN Gateway: $vpnGwName ($($azParams.vpnGateway.sku))" -ForegroundColor White
 Write-Host "`n⏱ Estimated time: 30-45 minutes" -ForegroundColor Yellow
 ...
 Write-Host $("="*60) -ForegroundColor Cyan
 Write-Host "`n This requires an existing vNet" -ForegroundColor Yellow
 ...
 Write-Host "`n⏱ Estimated time: 5-10 minutes + wait for flow logs to start" -ForegroundColor Yellow
 ...
 Write-Host "`n This requires existing flow logs with active data" -ForegroundColor Yellow
 ...
 Write-Host "`n⏱ Estimated time: < 1 minute" -ForegroundColor Yellow
